...
package androidx.compose.material.symbols.generator.vector
 ...
 */
class Vector(val autoMirrored: Boolean, val viewportWidth: Float?, val viewportHeight: Float?, val nodes: List<VectorNode>)
