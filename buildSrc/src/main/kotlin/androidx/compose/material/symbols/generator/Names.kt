...
enum class PackageNames(val packageName: String) {
    MaterialSymbolsPackage("dev.tclement.compose.symbols"),
 ...
 */
object ClassNames {
    val Symbols = PackageNames.MaterialSymbolsPackage.className("Symbols")
 ...
 */
object MemberNames {
    val MaterialSymbol = MemberName(PackageNames.MaterialSymbolsPackage.packageName, "materialSymbol")
    val MaterialPath = MemberName(PackageNames.MaterialSymbolsPackage.packageName, "materialPath")
